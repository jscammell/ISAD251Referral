...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="w3-row-padding w3-margin-bottom">
    ...
    <h1 style="color: black;"> Add Notes To Previous Appointments</h1>

    <form method="post" action="../ServerSideCode/AddNotesToPreviousAppointments.php" id="CreateFamilyDeadline" >
            <br>
